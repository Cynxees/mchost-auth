...
import (
	"fmt"
	"mchost/auth/server/api"
	"mchost/auth/server/config"
	manager "mchost/auth/server/jwt"

	// "mchost/auth/server/lib/rabbitmq"
	"mchost/auth/server/models"
	"mchost/auth/server/pb"
	"net"
	"net/http"
	"time"

	"mchost/auth/www/docs"
...
func main() {
	...
	dsn := "user:password@tcp(127.0.0.1:3306)/mchost_auth?charset=utf8mb4&parseTime=True&loc=Local"
